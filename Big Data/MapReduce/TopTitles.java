...
// <<< Don't Change
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        // TODO
            ...
            while (tokenizer.hasMoreTokens()) {
                String nextToken = tokenizer.nextToken().toLowerCase();
    ...
    public static class TopTitlesMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        Integer N;
        // TODO
        //@ Zijiao: Mapper put top N words into a set and return it; Reduce gather all sets and get the top N
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            // TODO
            // some functional work; NOTICE that output pairs with empty key
