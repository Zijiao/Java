...
public class TopNFinderBolt extends BaseBasicBolt {
 ...
 /*
    ...
    // @Zijiao: if currentTopWords size is larger than N, delete the smallest one
    ...
    if (currentTopWords.size() > this.N) {
      Collection<Integer> counts = currentTopWords.values();
      Integer minVal = Collections.min(counts);
